...
- **beo-validating**: plan-checker and bead-reviewer prompts must follow rules 1-4 when reporting dimension failures.
- **beo-reviewing**: specialist review prompts must follow rules 1-4 when classifying P1/P2/P3 findings.
- **beo-debugging**: diagnostic reports should follow rules 2-4 (evidence, failure scenario, minimal fix) when presenting root cause analysis.
