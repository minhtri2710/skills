...
Use `beo-reference -> doctrine-map.md` as the short source-of-truth registry for shared doctrine ownership.
...
| bead/status/label mapping | `beo-reference -> status-mapping.md` | Status mapping |
| go-mode macro behavior | `beo-reference -> go-mode.md` | Operator behavior |
...
- let `beo-reference -> pipeline.md` own allowed handoffs and state-transition routing
- let `beo-reference -> approval.md` own approval freshness, grant, refresh, and invalidation semantics
- let `beo-reference -> artifacts.md` own artifact schemas and writer boundaries
- let `beo-reference -> state.md` own handoff freshness and route/state evidence fields
...
| `references/validation-operations.md` | readiness operations, PASS/FAIL, validation handoffs | `beo-validate`; `beo-reference -> approval.md`; `beo-reference -> pipeline.md` | Primary decision; Approval; Allowed handoffs | local runtime doctrine merged |
| `references/reviewing-operations.md` | verdict operations, reactive fix, approval retention | `beo-review`; `beo-reference -> artifacts.md`; `beo-reference -> approval.md` | Primary decision; REVIEW schema; approval invariants | local runtime doctrine merged |
| `references/compounding-operations.md` | accepted-review learning flow | `beo-compound`; `beo-reference -> learning.md` | Primary decision; Feature learning schema | local runtime doctrine merged |
