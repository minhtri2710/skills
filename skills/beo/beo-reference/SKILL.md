---
name: beo-reference
description: "Read-only lookup for BEO doctrine, registries, command authority, transitions, schemas, and safety invariants. Use for BEO rule/schema questions, not delivery execution, approval, or review. Never mutates delivery state."
---
# beo-reference

Canonical lookup router: `references/doctrine-map.md`.
