...
function statusScriptContent() {
  ...
  return [
    ...
    '    read_only: true,',
    "    authority_notice: 'status is advisory/display only; it cannot route, approve, validate readiness, emit review verdicts, select execution sets, or promote learning',",
    '    not_live_checked: true,',
    '    onboarding: {',
    '      status: onboardingStatus,',
    '      live_check_required: true,',
    "      live_check_command: 'node skills/beo/onboard/scripts/onboard_beo.mjs --repo-root \"$(pwd)\"',",
    '    },',
    '    state: {',
