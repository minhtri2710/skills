...
- Rows answered under a Human standing delegation are relayed and recorded under the same attribution rule, naming the delegation; use `lead.md`, "**Standing delegation.**" for the row shape.
