...
- attention events the Lead appends: a Human gate opened, a product fork needing the Human, a `REOPEN_REQUEST`, a `BLOCKED` routed upward, the repair cap reached, a red CI result after a push or merge, a Lead seat compacted or relaunched, a final handoff;
