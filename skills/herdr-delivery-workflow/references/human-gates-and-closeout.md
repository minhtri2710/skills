...
A gate that lives only in the Lead's run context dies with the pane. Append one line per gate to `~/.herdr/projects/<project-slug>/gates.md`, beside the project config, creating the directory when needed:
